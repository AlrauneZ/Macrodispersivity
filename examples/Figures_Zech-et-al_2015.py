...
from analysis.preasymptotic_alphaL import generate_random_preasymptotic_alpha
from analysis.preasymptotic_alphaL import random_selection
from data.data_dispersivity_table import select_data_alphaL
from visualize.plot_dispersivity_data import plot_aL_aquifer
from visualize.plot_dispersivity_data import plot_alphaL_vs_scale
from visualize.plot_dispersivity_preasymptotic import plot_random_alphaL_preasymptotic
...
plot_alphaL_vs_scale(data_alphaL,
                     # save_fig = "Zech-et-al-2015_Fig4_Longitudinal_Dispersivities.pdf",
                     )
...
plot_aL_aquifer(data_aquifers,
                figsize= [6,4],
                ylim = [0.1,200],
                # save_fig = "Zech-et-al-2015_Fig5_Aquifer_dispersivities.pdf",
                )
...
fig = plot_random_alphaL_preasymptotic(x_random,
                                 ...
                                 # save_fig = "Zech-et-al-2015_Fig6_Computational_Example.pdf",
                                 )
